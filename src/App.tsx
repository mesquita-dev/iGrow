...
const partnerLogos = [
  ...
  { name: "Bradesco Seguros", url: "https://logo.clearbit.com/bradescoseguros.com.br" },
  { name: "HDI", url: "https://logo.clearbit.com/hdi.com.br" },
  { name: "Excelsior", url: "https://logo.clearbit.com/excelsiorseguros.com.br" },
  { name: "Newe Seguros", url: "https://logo.clearbit.com/newe.com.br" },
  { name: "AKAD", url: "https://logo.clearbit.com/akadseguros.com.br" }
];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-[#F0F0F0] bg-[#344F58]">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center bg-[#1a282d] pt-32 pb-20 lg:pt-40 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-12 grid grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            >
              ...
              >
                {["A", "tecnologia", "que", "protege", "sua", "safra."].map((text, i) => (
                  ...
                  >
                    {text === "protege" ? (
                      <span className="text-editorial-accent font-bold not-italic tracking-tighter">
                        {text}
                      </span>
                    ) : (
                      text
                    )}
                    {["tecnologia", "que", "protege"].includes(text) && <br className="hidden lg:block" />}
                  </motion.span>
                ))}
              </motion.h1>
              
              <p className="text-sm md:text-lg text-white/50 mb-10 md:mb-12 leading-relaxed font-light max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row items-center lg:items-start gap-8 md:gap-10">
                <motion.a 
                  href="#contact" 
                  whileHover="hover"
                  initial="initial"
      ...
      <div className="bg-editorial-accent py-12 overflow-hidden border-y border-white/5 relative">
          ...
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex gap-24 items-center pr-24">
              {partnerLogos.map((partner) => (
                <div key={`${partner.name}-${i}`} className="h-10 w-auto flex items-center justify-center">
                  <img 
                    src={partner.url} 
                    alt={partner.name}
                    className="h-full w-auto object-contain grayscale brightness-[0.2] contrast-[1.5] opacity-40 hover:opacity-100 transition-all duration-500"
                    referrerPolicy="no-referrer"
                  />
                </div>
              ))}
      ...
      <section id="services" className="py-32 bg-agro-dark relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 mb-20 flex justify-between items-end">
          <motion.div
      ...
      <section id="contact" className="py-32 bg-agro-dark relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="card-glass p-6 md:p-24 relative overflow-hidden">
              ...
              <div>
                ...
                <div className="space-y-10">
                  <div className="flex items-start">
                    <div className="w-10 h-10 md:w-12 md:h-12 card-glass flex items-center justify-center mr-4 md:mr-8 shrink-0">
                      <Phone className="text-editorial-accent" size={18} />
                    </div>
                    <div>
                      <p className="text-white/30 font-bold uppercase tracking-[0.2em] text-[8px] md:text-[9px] mb-1">WhatsApp direto</p>
                      <p className="text-white text-base md:text-xl font-medium tracking-tight hover:text-editorial-accent transition-colors cursor-pointer">(34) 99771-3987</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="w-10 h-10 md:w-12 md:h-12 card-glass flex items-center justify-center mr-4 md:mr-8 shrink-0">
      ...
      <footer className="bg-[#152024] pt-24 pb-12 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
            <div className="col-span-1 md:col-span-2 lg:col-span-1">
              ...
              <p className="text-white/40 text-sm leading-relaxed max-w-xs font-light">
                Consultoria especializada em gestão de riscos e seguros para o agronegócio e grandes frotas.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-white/5 gap-8">
            <div className="flex items-center gap-4">
              <ShieldCheck size={14} className="text-editorial-accent/40" />
              <p className="text-[9px] uppercase tracking-widest text-white/20">iGrow Seguros • Corretora de Seguros Premium</p>
            </div>
            
            <div className="flex items-center gap-12">
               <span className="text-[9px] uppercase tracking-widest text-white/20">Susep: 202105.123456</span>
               <p className="text-[9px] uppercase tracking-widest text-white/20">© 2026 iGrow Seguros</p>
            </div>
          </div>
        </div>
      </footer>
